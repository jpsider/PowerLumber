...
Describe "Write-Message function for $moduleName" {
    function New-Log {}
    ...
    It "Should not Throw if the log file does exist" {
        ...
        {Write-Message -Message "I love lamp" -Logfile "C:\fakepath\mylog.log" -OutputStyle noConsole} | Should -not -Throw
    ...
    It "Should Throw if the log file does not exist and could not be created." {
        ...
        Mock -CommandName 'Write-Warning' -MockWith {}
        Mock -CommandName 'Get-Timestamp' -MockWith {}
        {Write-Message -Message "I love lamp" -Logfile "C:\fakepath\mylog.log" -OutputStyle noConsole} | Should -Throw
        Assert-MockCalled -CommandName 'Write-Output' -Times 2 -Exactly
    ...
    It "Should not Throw." {
        ...
        {Write-Message -Message "I love lamp" -Logfile "C:\fakepath\mylog.log" -OutputStyle both} | Should -not -Throw
    ...
    It "Should not Throw -output style both, failed test-path." {
        ...
        Mock -CommandName 'Write-Warning' -MockWith {}
        {Write-Message -Message "I love lamp" -Logfile "C:\temp\mylog.log" -OutputStyle both} | Should -not -Throw
    ...
    It "Should not Throw. No output style." {
        ...
        Mock -CommandName 'Write-Warning' -MockWith {}
        {Write-Message -Message "I love lamp" -Logfile "C:\temp\mylog.log"} | Should -not -Throw
    ...
    It "Should not Throw. ConsoleOnly" {
        ...
        Mock -CommandName 'New-Log' -MockWith {}
        Mock -CommandName 'Get-Timestamp' -MockWith {}
        {Write-Message -Message "I love lamp" -OutputStyle ConsoleOnly} | Should -not -Throw
    ...
    It "Should Throw. Console Only, Write-Output failed" {
        ...
        Mock -CommandName 'New-Log' -MockWith {}
        Mock -CommandName 'Get-Timestamp' -MockWith {}
        {Write-Message -Message "I love lamp" -OutputStyle ConsoleOnly} | Should -Throw
